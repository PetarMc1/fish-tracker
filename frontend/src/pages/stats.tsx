  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0f0f11] to-[#1a1a1d] p-8 text-white font-sans pt-16">
      <section className="max-w-6xl mx-auto space-y-12">
        ...
        {/* Cards Grid with Crab on top-left */}
        <section>
          <motion.div
          ...
          >
            ...
            <motion.div
              ...
              animate="visible"
              exit="hidden"
              className="bg-gradient-to-br from-yellow-800/30 to-yellow-900/60 border border-yellow-700/50 backdrop-blur-lg p-6 rounded-3xl shadow-md cursor-pointer flex flex-col items-center"
            >
              <Image
                src="/crab.png"
                alt="Crab"
              ...
              <p
                className="text-center italic tracking-wide font-semibold text-yellow-400"
                style={{ color: "#facc15" }}
              >
                Rarity: ???
              </p>
            ...
            {fishList.map(([name, count]) => {
              const rarity =
                fishRarities[name]?.toLowerCase() || "unknown/other";
              ...
              return (
                <motion.div
                  ...
                  animate="visible"
                  exit="hidden"
                  className="bg-gradient-to-br from-blue-900/30 to-purple-900/60 border border-white/20 backdrop-blur-lg p-6 rounded-3xl shadow-md cursor-pointer flex flex-col items-center"
                >
                  <Image
                  ...
                  <p className="text-center italic tracking-wide font-semibold text-blue-400">
